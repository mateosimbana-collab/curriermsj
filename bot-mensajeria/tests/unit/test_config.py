...
def clean_env(monkeypatch):
    ...
    for var in [
        ...
        "HOST", "PORT", "FLASK_DEBUG", "BUSINESS_NAME", "BOT_NAME",
        "ROUTE_LABEL", "SUPPORT_HOURS", "WELCOME_IMAGE_URL",
        "WHATSAPP_API_VERSION", "META_APP_SECRET",
    ]:
...
class TestConfigDefaults:
    ...
    def test_debug_default_false(self, clean_env):
        cfg = reload_config()
    ...
    def test_webhook_verify_token_default(self, clean_env):
        cfg = reload_config()
        assert cfg.WEBHOOK_VERIFY_TOKEN == ""
    ...
    def test_whatsapp_api_url_requires_version(self, clean_env):
        cfg = reload_config()
        assert cfg.WHATSAPP_API_URL == ""
...
class TestConfigEnvOverrides:
    def test_all_vars_from_env(self, monkeypatch):
        ...
        assert cfg.WHATSAPP_API_URL == "https://graph.facebook.com/v99.0"
